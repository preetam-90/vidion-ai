...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <div
      className={`fixed inset-y-0 left-0 z-50 w-64 bg-[#202123] transform transition-transform duration-200 ease-in-out ${
    ...
    >
      <div className="flex flex-col h-full max-h-screen overflow-hidden">
        <button 
          ...
          className="hidden md:flex absolute -right-4 top-4 bg-gray-800 rounded-full p-1 shadow-md z-10 hover:bg-gray-700"
        ...
        <div className="p-2 shrink-0">
          <button
            ...
            className={`w-full flex items-center gap-3 rounded-md border border-white/20 text-white px-3 py-3 text-sm hover:bg-gray-700 transition-colors ${!isOpen && "md:justify-center md:px-1"}`}
          >
            <PlusIcon size={16} />
        ...
        <div className={`flex-1 overflow-y-auto scrollbar-thin py-2 ${!isOpen && "md:hidden"}`}>
        ...
        <div className={`p-3 border-t border-gray-700 mt-auto shrink-0 ${!isOpen && "md:hidden"}`}>
